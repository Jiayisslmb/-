    ...
    const fetchPostDetails = async () => {
      try {
        ...
        setPost({
          ...
          likes: postData._count?.articlelike || postData.likes || 0,
          comments: postData._count?.articlecomment || postData.comments || 0,
          shares: postData._count?.articlerepost || postData.shares || 0,
  ...
  const handleReplySubmit = async (parentId: number, parentType: 'comment' | 'reply' = 'comment') => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const commentKey = 'articlecomment';
        const mappedReply = {
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center flex-wrap gap-1 mt-0.5">
                ...
                <span className="text-[#6364FF] text-xs font-medium bg-[#6364FF]/5 px-2 py-0.5 rounded-full ml-1">📝 文章</span>
              </div>
            </div>
          </div>
